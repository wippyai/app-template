...
The **Web Host** is a set of JS/CSS/HTML modules served from a CDN (e.g., `https://web-host.wippy.ai/webcomponents-1.0.14/`). It provides:
...
1. Import CSS via CDN URLs:
   - `https://web-host.wippy.ai/webcomponents-1.0.14/@wippy-fe/assets/theme-config.css` — theme variables
   - `https://web-host.wippy.ai/webcomponents-1.0.14/@wippy-fe/assets/preflight.css` — Tailwind reset (normalizes form elements)
   - `https://web-host.wippy.ai/webcomponents-1.0.14/@wippy-fe/assets/tailwind.css` — PrimeVue component styles
   - `https://web-host.wippy.ai/webcomponents-1.0.14/@wippy-fe/assets/iframe.css` — scrollbar styling
